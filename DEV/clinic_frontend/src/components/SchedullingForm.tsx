  ...
  return (
    <>
      <form
        ...
        >
        <h5>Data</h5>
        <input className="form-control" type="date" id="inputData"></input>
        <h5>Hora</h5>
        <select className="form-select" id="inputHora" defaultValue="Escolha a sua hora">
        ...
        <h5>Especialidade</h5>
        <select className="form-select" id="inputEspecialidade" defaultValue="Escolha o que procura">
